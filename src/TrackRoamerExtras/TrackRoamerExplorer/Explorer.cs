...
{
    [DisplayName("(User) Explorer - Trackroamer Version")]
    ...
    class Explorer : DsspServiceBase
    {
        ...
        const int WatchdogTimeout = 5000; // msec

        // for real laser (5 scans/sec) must be true, for Ultrasound scanner (1 scan/sec) - false: 
        const bool doCountdown = false;

        /// <summary>
        /// Interval between timer notifications.
        /// </summary>
        //const int WatchdogInterval = 100; // msec
        const int WatchdogInterval = 3000; // msec
        #endregion
		...
		//private pxbumper.ContactSensorArrayOperations _trackroamerbumperPort = new pxbumper.ContactSensorArrayOperations();
        ...
        {
            LogInfo("Explorer: BumpersUpdateHandler()");
