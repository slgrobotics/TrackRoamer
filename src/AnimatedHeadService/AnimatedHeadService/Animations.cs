    ...
    public class Animations : Dictionary<string, Animation>
    {
        public Animations()
        {
           ...
           this.Add("Eye Red Leftmost Off Slow", new Animation(
            ...
            const int HEAD_DOWN_TINY    = 1575;
            const int HEAD_UP           = 1100;
            const int HEAD_UP_SMALL     = 1300;
            const int HEAD_UP_TINY      = 1400;
            ...
            this.Add("Tilt Cycle Up Tiny Fast Stay Level", new Animation(
                AnimationChannels.ANIM_SERVO_TILT,
                new int[,] {
                    { -1, HEAD_UP_TINY, 2000 },
                    { -1, HEAD_LEVEL, 2000 },
            ...
            this.Add("Tilt Cycle Down Tiny Fast Stay Level", new Animation(
                AnimationChannels.ANIM_SERVO_TILT,
                new int[,] {
                    { -1, HEAD_DOWN_TINY, 2000 },
                    { -1, HEAD_LEVEL, 2000 },
                    { -1, HEAD_LEVEL, 6000 }
                }
            ));
