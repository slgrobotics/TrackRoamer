...
namespace TrackRoamer.Robotics.LibBehavior
{
    public class RoutePlan
    {
        ...
        public double? closestObstacleMeters;   // within the "planning" scan; used to evaluate safe speed 
        ...
        public bool isGoodPlan { get { return closestObstacleMeters.HasValue && bestHeading.HasValue; } }
