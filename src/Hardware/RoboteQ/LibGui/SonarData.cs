...
namespace LibGui
{
	...
	public class RangeReading
	{
		...
		public RangeReading(int _angleRaw, double _rangeMeters)
		{
			angleRaw = _angleRaw;
	...
	public class SonarData
	{
		...
		private int intervalToRememberS = 10;

		public void addRangeReading(int angleRaw, double rangeMeters)
		{
			lock (this)
			{
				RangeReading rr = new RangeReading(angleRaw, rangeMeters);
