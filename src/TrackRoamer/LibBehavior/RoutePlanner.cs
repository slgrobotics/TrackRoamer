...
namespace TrackRoamer.Robotics.LibBehavior
{
    public class RoutePlanner
    {
        ...
        public static string missionFilename = @"C:\Microsoft Robotics Dev Studio 4\Missions\around_the_parking_lot.txt";
        //public static string missionFilename = @"C:\Microsoft Robotics Dev Studio 4\Missions\woodcrest-library-parking.txt";
        ...
        public double ObstacleDistanceMeters = 0.6d;    // set by Tactics - if an obstacle comes within this distance the robot stops moving.
